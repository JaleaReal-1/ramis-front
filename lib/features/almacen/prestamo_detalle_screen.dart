...
class PrestamoDetalleScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PrestamoDetalleScreen> createState() =>
      _PrestamoDetalleScreenState();
}

class _PrestamoDetalleScreenState
    extends ConsumerState<PrestamoDetalleScreen> {
        ...
        child: Column(
          children: [
            ...
            _buildCard(
              ...
              title: 'Trabajador',
              children: [
                _infoRow(LucideIcons.hash, 'Código', data['codigo_unico']),
            ...
            _buildCard(
              ...
              children: [
                _infoRow(LucideIcons.calendarPlus, 'Préstamo',
                    formatDate(data['fecha_prestamo'])),
                _infoRow(LucideIcons.calendarClock, 'Devolución',
                    formatDate(data['fecha_devolucion_prevista'])),
              ],
            ),

            const SizedBox(height: 20),

            // Tarjeta de artículos (ahora en tabla)
            _buildCard(
