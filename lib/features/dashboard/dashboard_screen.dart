...
class _DashboardScreenState extends ConsumerState<DashboardScreen> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          // 🟢 BOTÓN CARRITO PRÉSTAMO (AQUÍ VA LO QUE NO ENTENDÍAS)
  ...
  Widget _buildCartBadge(int count) {
    return IconButton(
      icon: Badge(
        label: Text('$count'),
        child: const Icon(LucideIcons.shoppingCart, color: Colors.orangeAccent),
      ),
        ...
        return Card(
          ...
          child: ExpansionTile(
            leading: Icon(
              ...
              color: esEnviado ? Colors.green : Colors.blueGrey,
            ),
                  ...
                  children: [
                    ...
                    ElevatedButton.icon(
                      style: ElevatedButton.styleFrom(
                        backgroundColor: esEnviado ? Colors.grey : AppTheme.primary,
